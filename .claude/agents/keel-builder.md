...
never open a pull request. Use conventional commits and end every commit message with the
trailer lines given in your task. Record deviations as ADRs in `docs/decisions/` and results
