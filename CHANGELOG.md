...
- Rules add tags through the tag service (same case-insensitive lookup as the editor).
...
| `dotnet test Keel.sln -m:1` | 1,836 passed, 4 skipped (gated): Domain 1,046, Infrastructure 489 + 4 skipped, Desktop 301 |
